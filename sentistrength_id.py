...
class sentistrength:
    ...
    def main(self,sentence):
        ...
        #return {"classified_text":". ".join(self.sentences_score),"RESULT : ":self.sentences_max_pos+self.sentences_max_neg ,"tweet_text":". ".join(self.sentences_text),"sentence_score":self.sentences_score,"max_positive":self.sentences_max_pos,"max_negative":self.sentences_max_neg,"kelas":sentence_result}
       ...
       # return {"RESULT : ": self.sentences_max_pos + self.sentences_max_neg,
        ...
        return {"text ": " ".join(self.sentence_score) , "sentimen": sentence_result}
